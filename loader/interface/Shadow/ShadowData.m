...
-(void)setup{
    ...
    settingspath = IotaAssetSettingsPath;
    overridespath = IotaAssetOverridesPath;
...
+(NSMutableArray*)getThemes{
    NSMutableArray * themes = [[[NSFileManager defaultManager] contentsOfDirectoryAtPath:IotaAssetThemePath error:nil] mutableCopy];
    return themes;
}
