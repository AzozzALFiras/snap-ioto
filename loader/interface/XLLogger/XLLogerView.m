...
- (void)initTopViews {
    ...
    [closeBtn setImage:[UIImage imageWithContentsOfFile:@"/Library/Application Support/iota.bundle/logger/close.png"] forState:UIControlStateNormal];
    ...
    
    {
        ...
        [clearBtn setImage:[UIImage imageWithContentsOfFile:@"/Library/Application Support/iota.bundle/logger/clear.png"] forState:UIControlStateNormal];
...
- (void)initBottomViews {
    ...
    [checkBtn setImage:[UIImage imageWithContentsOfFile:@"/Library/Application Support/iota.bundle/logger/radio_uncheck.png"] forState:UIControlStateNormal];
    [checkBtn setImage:[UIImage imageWithContentsOfFile:@"/Library/Application Support/iota.bundle/logger/radio_checked.png"] forState:UIControlStateSelected];
